...
didn't comment out main
code is hard to read - add white space
functions arent clearly distinct
bracket formatting/tabbing is bad

pros: sorting array first is smart
comments explain code, but theyre poorly formatted and placed
